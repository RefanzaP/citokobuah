						...
						<form action="<?php base_url(" admin/supplier/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="name" placeholder="Nama" value="<?php echo $supplier->Supplier_name ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
								 type="text" name="address" min="0" placeholder=" Alamat" value="<?php echo $supplier->Supplier_address ?>" />
								<div class="invalid-feedback">
